import { BitcoinChainUpdate, StacksChainUpdate, Transaction } from "@hirosystems/chainhook-types";
...
export declare class DevnetNetworkFactory {
    private static instance;
    private nextNetworkId;
    private constructor();
    static sharedInstance(): DevnetNetworkFactory;
    buildNetwork(manifest: NetworkConfig): DevnetNetworkOrchestrator;
}
export declare function getIsolatedNetworkConfigUsingNetworkId(networkId: number, networkConfig: NetworkConfig, interval?: number): {
    clarinetManifestPath: string;
    logs: boolean;
    accounts: Account[];
    devnet: {
        ...
        stacks_explorer_port: number;
        bitcoin_explorer_port: number;
        subnet_node_p2p_port: number;
        subnet_node_rpc_port: number;
        subnet_api_port: number;
        subnet_api_events_port: number;
    } & DevnetConfig;
};
export declare class DevnetNetworkOrchestrator {
    handle: any;
     ...
     */
    constructor(config: NetworkConfig, defaultCooldown?: number);
    /**
     * @summary Start orchestrating containers
     * @memberof DevnetNetworkOrchestrator
     */
    start(timeout?: number, emptyBuffer?: boolean): any;
    /**
     ...
     * @memberof DevnetNetworkOrchestrator
     */
    getStacksExplorerUrl(): any;
    /**
     * @summary Returns the URL of the bitcoin-explorer container
     * @memberof DevnetNetworkOrchestrator
     */
    getBitcoinExplorerUrl(): any;
    /**
     * @summary Wait for the next Stacks block
     * @memberof DevnetNetworkOrchestrator
     */
    waitForNextStacksBlock(maxErrors?: number, emptyQueuedBlocks?: boolean): Promise<StacksChainUpdate>;
    /**
     * @summary Wait for the next Stacks block
     * @memberof DevnetNetworkOrchestrator
     */
    mineBitcoinBlockAndHopeForStacksBlock(emptyQueuedBlocks?: boolean): Promise<StacksChainUpdate | undefined>;
    /**
     * @summary Wait for the next Stacks block
     * @memberof DevnetNetworkOrchestrator
     */
    waitForStacksBlockOfHeight(targetBlockHeight: number, maxErrors?: number, emptyQueuedBlocks?: boolean): Promise<StacksChainUpdate>;
    /**
     * @summary Wait for the next Stacks block
     * @memberof DevnetNetworkOrchestrator
     */
    waitForStacksBlockAnchoredOnBitcoinBlockOfHeight(minBitcoinBlockHeight: number, maxErrors?: number, emptyQueuedBlocks?: boolean): Promise<StacksChainUpdate>;
    /**
     * @summary Wait for the next Bitcoin block
     * @memberof DevnetNetworkOrchestrator
     */
    waitForNextBitcoinBlock(): Promise<BitcoinChainUpdate>;
    /**
     * @summary Wait for the next Bitcoin block
     * @memberof DevnetNetworkOrchestrator
     */
    waitForStacksBlockIncludingTransaction(txid: string, ttl?: number): Promise<{
