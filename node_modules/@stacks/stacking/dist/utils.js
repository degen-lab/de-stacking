...
exports.ensureLegacyBtcAddressForPox1 = exports.ensurePox2IsLive = exports.unwrapMap = exports.unwrap = exports.poxAddressToBtcAddress = exports.poxAddressToTuple = exports.getErrorString = exports.extractPoxAddressFromClarityValue = exports.decodeBtcAddress = exports.btcAddressVersionToLegacyHashMode = exports.InvalidAddressError = void 0;
...
function ensurePox2IsLive(operationInfo) {
    if (operationInfo.period === constants_1.PoxOperationPeriod.Period1)
        throw new Error(`PoX-2 is not live yet (currently in period ${operationInfo.period} of PoX-2 operation)`);
}
exports.ensurePox2IsLive = ensurePox2IsLive;
